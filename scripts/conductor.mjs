...
// Human-signed security waivers (docs/work/SECURITY_WAIVERS.md). A CRITICAL that
// matches an active waiver is downgraded to a logged known-risk instead of halting
// the run. Waivers MUST be human-signed (agent names rejected) — this is a
// NEVER-AUTO surface: the conductor can never waive its own security findings.

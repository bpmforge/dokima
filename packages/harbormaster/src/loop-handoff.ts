 ...
 * thin projection of a `@shipwright/tickets` `Ticket` onto the typed
...
import { ROLE_CODING_AGENT } from '@shipwright/gateway';
import type { Handoff, HandoffTicket } from '@shipwright/loop';

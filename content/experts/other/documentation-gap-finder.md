...
Read `content/protocols/LOOP_PREVENTION.md`. Hard cap: 20 tool calls. For large codebases, sample rather than exhaustively scan — cover the most-exposed public surface first.
